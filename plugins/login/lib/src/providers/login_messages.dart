...
class LoginMessages with ChangeNotifier {
  LoginMessages({
    ...
    this.touristMode: defaultTouristMode,
    this.userIdHint:defaultuserIdHint,
  });
  ...
  static const defaultTouristMode = 'tourist Mode';
  static const defaultuserIdHint = 'id';
